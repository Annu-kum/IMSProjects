  ...
  return (
    ...
    >
      <Stack spacing={1} direction='row' className='ins-buttons'>
        ...
        <CustomButton variant="outlined" size="medium" onClick={handleClickOpen} ><AddIcon fontSize="small" sx={{ mr: "10px" }} />OTR Extend Entry</CustomButton>
        <Dialog
          fullScreen
          open={open}
          onClose={handleClose}
