...
const getData = async (start, end) => {
  try {
    ...
    const response = await axios.get(`https://ims.digitaaz.com/deactivation/getdeactivatedetai/`, {
      params: {
...
const refreshBtn=()=>{
  ...
  const pdfs = () => {
    ...
    doc.text('Deactivation Report', 12, 10);
    doc.autoTable({
    ...
    doc.save('Deactivation Report.pdf');
  };
...
{ key: 'Remark3',align:'center', label: 'Remark 3', width: 100,},
  ...
  return (
    ...
    <Button
      ...
      >
        <CSVLink filename="Deactivation_report.csv" headers={csvHeaders} data={filteredRows} style={{textDecoration:'none',color:'inherit'}}>Export</CSVLink>
      </Button>
